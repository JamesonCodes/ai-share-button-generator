        ...
        >
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4 mt-3 transition-smooth" style={{ color: 'var(--text-secondary)' }}>
              ...
              <li><a href="https://twitter.com/en/privacy" target="_blank" rel="noopener noreferrer" className="underline" style={{ color: 'var(--accent)' }}>X (Twitter) Privacy Policy</a></li>
            </ul>
          </section>
