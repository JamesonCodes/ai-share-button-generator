        ...
        >
          <section>
            ...
            <p className="transition-smooth" style={{ color: 'var(--text-secondary)' }}>
              The AI Share Button Generator ("Service") is operated by SearchWell Labs LLC. The information on 
          ...
          <section>
            ...
            <p className="transition-smooth" style={{ color: 'var(--text-secondary)' }}>
              The code generated by our Service is provided "as-is" without warranty of any kind. While we strive 
