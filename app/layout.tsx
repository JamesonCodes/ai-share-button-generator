...
export const metadata: Metadata = {
  ...
  description: "Generate embeddable AI share buttons for your blog or website. Let readers send articles to ChatGPT, Perplexity, or Google AI with one click. Free, lightweight, and easy to use.",
  keywords: [
    "AI share button",
